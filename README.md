...
* 2015-06-13:
  * mlr 2.5 released to CRAN. Among many minor cleanups and fixes it features: a) Quite a few new learners b) plots and statistical tests to analyse benchmark results (e.g. Demsar) c) partial depedency plots for all models (which I like quite a lot) d) first support for multilabel classification 
* 2015-06-27:
