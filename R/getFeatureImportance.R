...
#' *  `h2o`\cr
#'    Relative feature importance as returned by [h2o:h2o.varimp].
#' *  `randomForest`\cr
...
#'    See [randomForestSRC:vimp] for details.
#' *  `ranger`\cr
...
#'   generating function.
#' @return ([FeatureImportance]) An object containing a long `data.frame` of the
