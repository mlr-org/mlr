...
makeTuneControlCMAES = function(same.resampling.instance = TRUE, impute.val = NULL, start = NULL,
  ...
  ctrl = makeTuneControl(same.resampling.instance = same.resampling.instance, impute.val = impute.val,
    ...
    log.fun = log.fun, budget = budget, ..., cl = "TuneControlCMAES")
  ...
  # if at least two of the three arguments budget, lambda and maxit are given,
  # all three will have to follow the equation budget = lambda * maxit
