...
makeRLearner.classif.earth = function() {
  makeRLearnerClassif(
    ...
    par.set = makeParamSet(
      makeNumericLearnerParam(id = "trace", default = 0, lower = 0, upper = 5, tunable = FALSE),
      ...
      makeNumericLearnerParam(id = "thres", default = 0.001, lower = 0),
      makeIntegerLearnerParam(id = "minspan", default = 0L),
      makeIntegerLearnerParam(id = "endspan", default = 0L),
      makeNumericLearnerParam(id = "newvar.penalty", default = 0, lower = 0),
      makeIntegerLearnerParam(id = "fast.k", default = 20L, lower = 0L),
      makeNumericLearnerParam(id = "fast.beta", default = 1, lower = 0),
      ...
      makeIntegerLearnerParam(id = "ncross", default = 1L, lower = 1L),
      makeIntegerLearnerParam(id = "nfold", default = 0L, lower = 0L),
