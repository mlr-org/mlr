...
makeRLearner.regr.h2o.gbm = function() {
  makeRLearnerRegr(
    ...
    par.set = makeParamSet(
      ...
      makeNumericLearnerParam("max_abs_leafnode_pred", lower = 0, default = Inf),
      makeNumericLearnerParam("pred_noise_bandwidth", lower = 0, default = 0),
      makeDiscreteLearnerParam("categorical_encoding",
                               values = c("auto", "enum", "enum_limited", "one_hot_explicit", "binary",
                                          "eigen", "label_encoder", "sort_by_response"),
                               default = "auto"),
      ...
      makeDiscreteLearnerParam("histogram_type",
                               ...
                               default = "AUTO"),
      makeDiscreteLearnerParam("score_each_iteration", default = FALSE, tunable = FALSE),
