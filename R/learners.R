...
#'   \item{\bold{classif.randomForestSRC}}{\cr Random Forest from randomForestSRC package: \code{\link[randomForestSRC]{rfsrc}}}
...
#'   \item{\bold{regr.randomForestSRC}}{\cr Random Forest from randomForestSRC package: \code{\link[randomForestSRC]{rfsrc}}}.
...
#'   \item{\bold{surv.randomForestSRC}}{\cr Random Forests for Survival from randomForestSRC package: \code{\link[randomForestSRC]{rfsrc}}}
#' }
#'
#' \itemize{
