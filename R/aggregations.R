...
test.mean = makeAggregation(
  ...
  name = "Test mean",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) mean(perf.test, na.rm = na.rm)
)
...
test.sd = makeAggregation(
  ...
  name = "Test sd",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) sd(perf.test, na.rm = na.rm)
)
...
test.median = makeAggregation(
  ...
  name = "Test median",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) median(perf.test, na.rm = na.rm)
)
...
test.min = makeAggregation(
  ...
  name = "Test minimum",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) min(perf.test, na.rm = na.rm)
)
...
test.max = makeAggregation(
  ...
  name = "Test maximum",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) max(perf.test, na.rm = na.rm)
)
...
test.sum = makeAggregation(
  ...
  name = "Test sum",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) sum(perf.test, na.rm = na.rm)
)
...
test.range = makeAggregation(
  ...
  name = "Test range",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) diff(range(perf.test, na.rm = na.rm))
)
...
test.rmse = makeAggregation(
  ...
  name = "Test RMSE",
  properties = "req.test",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) sqrt(mean(perf.test^2, na.rm = na.rm))
)
...
train.mean = makeAggregation(
  ...
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) mean(perf.train, na.rm = na.rm)
)
...
train.sd = makeAggregation(
  ...
  name = "Training sd",
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) sd(perf.train, na.rm = na.rm)
)
...
train.median = makeAggregation(
  ...
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) median(perf.train, na.rm = na.rm)
)
...
train.min = makeAggregation(
  ...
  name = "Training min",
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) min(perf.train, na.rm = na.rm)
)
...
train.max = makeAggregation(
  ...
  name = "Training max",
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) max(perf.train, na.rm = na.rm)
)
...
train.sum = makeAggregation(
  ...
  name = "Training sum",
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) sum(perf.train, na.rm = na.rm)
)
...
train.range = makeAggregation(
  ...
  name = "Training range",
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) diff(range(perf.train, na.rm = na.rm))
)
...
train.rmse = makeAggregation(
  ...
  name = "Training RMSE",
  properties = "req.train",
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) sqrt(mean(perf.train^2, na.rm = na.rm))
)
...
b632 = makeAggregation(
  ...
  fun = function(task, perf.test, perf.train, measure, group, pred, na.rm = FALSE) {
