...
plotCritDifferences = function(obj, baseline = NULL) {
  ...
  p = ggplot(obj$data) + 
    geom_point(aes_string(x = "mean.rank", y = 0, color = "learner.id"), size = 3) +
    geom_segment(aes_string(x = "mean.rank", xend = "mean.rank", y = 0, yend = "yend",
                     color = "learner.id"), size = 1) +
    geom_segment(aes_string(x = "mean.rank", xend = "xend", y = "yend", yend = "yend",
                     color = "learner.id"), size = 1) +
    geom_text(aes_string(x = "xtext", y = "yend", label = "learner.id",
  ...
  p = p + 
    ...
    p = p +
      geom_segment(aes_string(x = "xstart", xend = "xend", y = "y", yend = "y"),
