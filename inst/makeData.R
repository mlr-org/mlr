...
save(iris.task, file = file.path(dn, "iris.task.rda"))


set.seed(DATASEED)
data(Sonar, package = "mlbench")
sonar.task = makeClassifTask("Sonar-example", data = Sonar, target = "Class")
save(sonar.task, file = file.path(dn, "sonar.task.rda"), compress = "xz")
...
save(bh.task, file = file.path(dn, "bh.task.rda"), compress = "xz")
...
save(wpbc.task, file = file.path(dn, "wpbc.task.rda"), compress = "xz")
...
save(lung.task, file = file.path(dn, "lung.task.rda"), compress = "xz")
...
save(mtcars.task, file = file.path(dn, "mtcars.task.rda"), compress = "xz")


set.seed(DATASEED)
data(agriculture, package = "cluster")
agri.task = makeClusterTask("agriculture-example", data = agriculture)
save(agri.task, file = file.path(dn, "agri.task.rda"), compress = "xz")
...
save(costiris.task, file = file.path(dn, "costiris.task.rda"), compress = "xz")
...
save(yeast.task, file = file.path(dn, "yeast.task.rda"), compress = "xz")
...
save(gunpoint.task, file = file.path(dn, "gunpoint.task.rda"), compress = "xz")
...
save(fuelsubset.task, file = file.path(dn, "fuelsubset.task.rda"), compress = "xz")
...
fdata = makeFunctionalData(ph, fd.features = list(), exclude.cols = "classlearn")
phoneme.task = makeClassifTask(data = fdata, target = "classlearn")
save(phoneme.task, file = file.path(dn, "phoneme.task.rda"), compress = "xz")
