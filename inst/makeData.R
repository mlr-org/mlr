...
use_data(wpbc.task, overwrite = TRUE)
...
use_data(gunpoint.task, overwrite = TRUE)
...
use_data(fuelsubset.task, overwrite = TRUE)
...
use_data(phoneme.task, overwrite = TRUE)
...
spatial.task = makeClassifTask(target = "slides", data = ecuador, coordinates = coords,
                               positive = "TRUE")
use_data(spatial.task, overwrite = TRUE)
