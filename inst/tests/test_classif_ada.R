...
test_that("classif_ada", {
	...
	testSimple("classif.ada", binaryclass.df, binaryclass.target, binaryclass.train.inds, p.class)
	
	p = p[,1]
	testProb("classif.ada", binaryclass.df, binaryclass.target, binaryclass.train.inds, p)
