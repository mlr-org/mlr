...
test_that("FilterWrapper", {
  ...
  lrn2 = makeFilterWrapper(lrn1, fw.method = "chi.squared", fw.percentage = 1)
  ...
  lrn2 = makeFilterWrapper(lrn1, fw.method = "chi.squared", fw.n = 0)
  m = train(lrn2, binaryclass.task)
  ...
  lrn2 = makeFilterWrapper(lrn1, fw.method = "chi.squared", fw.percentage = 0.1)
