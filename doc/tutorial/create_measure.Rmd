...
provided list of [measures](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/measures.html) or a measure using a non-standard misclassification cost matrix.


Construct performance measure
-----------------------------

The [makeMeasure](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/makeMeasure.html) function is a simple way to construct your own performance 
...
in a Measure object. Then, we work with it as usual with the [performance](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/performance.html) function. See the 
R documentation of the [makeMeasure](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/makeMeasure.html) function for details on the various parameters.
...
the [makeCostMeasure](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/makeCostMeasure.html) function. In order to do this, you first need to define the cost
...
[performance](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/performance.html) function. See the R documentation of the [makeCostMeasure](http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/makeCostMeasure.html) function for 
