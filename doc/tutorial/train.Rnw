...
calling the function train_, passing it a Learner_ and a task_. 
In the examples above, the classification or regression method was specified 
by special Learner_ objects. This allows for a maximum of flexibility, for example it permits setting the hyperparameters of the learner before training. 
...
.. _WrappedModel: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/makeWrappedModel.html
.. _task: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/SupervisedTask.html