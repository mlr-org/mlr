...
section about :doc:`train` and :doc:`resample` -- simply use the
``par.val`` argument in the makeLearner_ method.

Assuming, you have understood how :doc:`resample` works, it is
...
task, just like in the tutorial on :doc:`train`:
...
More details concerning parameter sets are explained in section :doc:`parameters`.
...
like in the :doc:`resample` part of the tutorial:
...
.. _makeParamSet: http://www.statistik.tu-dortmund.de/~bischl/rdocs/ParamHelpers/html/makeParamSet.html
...
.. _resample: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/resample.html
.. _ParamSet: http://www.statistik.tu-dortmund.de/~bischl/rdocs/ParamHelpers/html/makeParamSet.html
.. _TuneControl: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlrTune/html/TuneControl.html

.. _training: :doc:`train`
.. _resampling: :doc:`resample`
