...
classification and RegrTask_ for regression problems.  A
...
The makeClassifTask_ help page lists several other arguments that can be 
...
which stands for description. (``task@desc`` is an object of class TaskDesc_.)
...
.. _LearnTask: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/SupervisedTask.html
.. _TaskDesc: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/TaskDesc.html
.. _ClassifTask: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/SupervisedTask.html
.. _RegrTask: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/SupervisedTask.html
.. _makeClassifTask: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/SupervisedTask.html
.. _makeRegrTask: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/SupervisedTask.html
.. _Training: train.html
