#' @param obj (list of [Prediction] | list of [ResampleResult] | [BenchmarkResult])\cr
#'   Single prediction object, list of them, single resample result, list of them, or `character(1)` benchmark result.
