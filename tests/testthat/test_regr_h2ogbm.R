...
test_that("regr_h2ogbm", {
  ...
  parset.list = list(
    ...
    list(ntrees = 5L, sample_rate = 0.5),
    list(ntrees = 5L, col_sample_rate = 0.5),
    list(ntrees = 5L, col_sample_rate_change_per_level = 0.9),
    list(ntrees = 5L, col_sample_rate_per_tree = 0.5),
    list(ntrees = 5L, max_abs_leafnode_pred = 200),
    list(ntrees = 5L, pred_noise_bandwidth = 0.2),
    list(ntrees = 5L, categorical_encoding = "OneHotExplicit"),
    list(ntrees = 5L, min_split_improvement = 1e-4),
    list(ntrees = 5L, histogram_type = "Random"),
