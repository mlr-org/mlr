context("ClassificationViaClusteringWrapper")

test_that("ClassificationViaClusteringWrapper predicts with response", {
  lrn1 = makeLearner("cluster.kmeans")
  lrn2 = makeClassificationViaClusteringWrapper(lrn1)
...
test_that("ClassificationViaClusteringWrapper predicts with prob", {
  lrn1 = makeLearner("cluster.kmeans")
  lrn2 = makeClassificationViaClusteringWrapper(lrn1, predict.type = "prob")
