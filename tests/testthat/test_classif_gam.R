...
test_that("classif_gam_binomial", {
  ...
  parset.list1 = list(
    ...
    #list(family = Tweedie(link = "inverse")),
    #list(family = Tweedie(link = "sqrt")),
    #list(family = Tweedie(link = "log")),
    #list(family = Tweedie(link = "identity")),
    #list(family = Tweedie(link = "sqrt")),
    #list(family = negbin(link = "log")),
    #list(family = negbin(link = "identity")),
    #list(family = negbin(link = "sqrt"))
  )
  ...
  parset.list2 = list(
    ...
    ### here we need to set 'p' accordingly. see help pages
    # list(family = "Tweedie.link", quasibinomial.link = "log", formula = fo),
    # list(family = "Tweedie.link", quasibinomial.link = "identity", formula = fo),
    # list(family = "Tweedie.link", quasibinomial.link = "inverse", formula = fo),
    # list(family = "Tweedie.link", quasibinomial.link = "sqrt", formula = fo),
    # list(family = "negbin.link", quasibinomial.link = "log", formula = fo),
    # list(family = "negbin.link", quasibinomial.link = "identity", formula = fo),
    # list(family = "negbin.link", quasibinomial.link = "sqrt", formula = fo)
  )
