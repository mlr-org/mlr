context("classif_cv.glmnet")

# test_that("classif_cv.glmnet", {
#   library(glmnet)
#   parset.list = list(
#     list(),
#     list(alpha = 0.5),
...
#   }
#
#   testSimpleParsets("classif.cv.glmnet", binaryclass.df, binaryclass.target,
#                     binaryclass.train.inds, old.predicts.list, parset.list)
#   testProbParsets ("classif.cv.glmnet", binaryclass.df, binaryclass.target,
