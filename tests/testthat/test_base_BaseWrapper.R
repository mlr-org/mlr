...
test_that("BaseWrapper", {
  ...
  expect_equal(getHyperPars(lrn2), list(minsplit = 2L, xval = 0L, foo = 3))
  lrn2 = setHyperPars(lrn2, minsplit = 11)
  expect_equal(getHyperPars(lrn2), list(minsplit = 11L, xval = 0L, foo = 3))
  lrn2 = setHyperPars(lrn2, foo = 12)
  expect_equal(getHyperPars(lrn2), list(minsplit = 11L, xval = 0L, foo = 12))
