...
test_that("learners work: classif", {
  ...
  lrns = lrns[extractSubList(lrns, "id", simplify = TRUE) %nin% c("classif.boosting", "classif.cvglmnet", "classif.dbnDNN", "classif.evtree", "classif.geoDA", "classif.linDA", "classif.linDA", "classif.lqa", "classif.lvq1", "classif.mda", "classif.pamr", "classif.plsdaCaret", "classif.quaDA", "classif.rknn", "classif.rotationForest", "classif.rrlda")]
