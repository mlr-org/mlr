...
#   expect_equal(sem.mlr, sem.fda.usc, tol = 0.1)
#   ###  sem.mlr - sem.fda.usc
#
#   # two data sets
...
#
#   expect_equal(sem.mlr.test, sem.fda.usc.test, tol = 0.1)
#
# })
#
...
#   # it gets more similar for larger values for nbasis
#
#   # # It seems that the new implementation works (slightly) better
#   # sum(as.character(gtest) == as.character(cp))
#   # sum(as.character(gtest) == as.character(p1))
# })
