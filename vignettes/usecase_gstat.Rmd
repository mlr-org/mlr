...
The examples presented in this vignette are inspired by the examples from the gstat [vignette](https://cran.r-project.org/web/packages/gstat/vignettes/gstat.pdf)
...
## Interactively mapping prediction with the attached standard error using leaflet
