...
The main goal of `mlr` is to provide a unified interface for *machine learning tasks* as *classification*, *regression*, *cluster analysis*, *survival analysis* and *one-classification (anomaly detection)* in R.
