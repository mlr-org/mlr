...
If your favourite option is not implemented in `mlr` yet, you can easily create your own imputation method (`vignette("create_imputation")`).
...
See also the list of integrated learners (`vignette("integrated_learners")`) in the Appendix.
...
In the following the 3-fold cross-validated mean squared error (`vignette("measures")`) is calculated.
