...
You might also want to have a look at the [source code](https://github.com/mlr-org/mlr/blob/main/R/Filter.R#L95) of the filter methods already integrated in `mlr` for some more complex and meaningful examples.
