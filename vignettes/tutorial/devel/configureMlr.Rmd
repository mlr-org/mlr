...
However, in some situations, for example if you conduct a larger [bechmark experiment](benchmark_experiments.html) with multiple data sets and learners, you usually don't want the whole experiment stopped due to one error.
