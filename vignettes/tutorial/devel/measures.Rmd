...
If you find that a measure is missing, you can either [open an issue](https://github.com/mlr-org/mlr/issues) or try to [implement a measure yourself](create_measure.html).
...
For details see the tutorial page on [cost-sensitive classification](cost_sensitive_classif.html) and also the page on [custom performance measures](create_measure.html).
