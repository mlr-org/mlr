...
A lot of feature filter methods are already integrated in `mlr` and a complete list is given in the [Appendix](filter_methods.html) or can be obtained using `listFilterMethods()`.
...
`makeFilterWrapper()`; see also the page on [feature selection](feature_selection.html).
