...
| generation function               | ggplot2 plotting function  | ggvis plotting function       | tutorial pages                                                                 |
 ...
 | `generateHyperParsEffectData()`   | `plotHyperParsEffect()`    |                               | `vignette("tune")`, `vignette("hyperpar_tuning_effects")`                |
 | `generateFilterValuesData()`      | `plotFilterValues()`       | `plotFilterValuesGGVIS()`     | `vignette("feature_selection")`                                                |
 | `generateLearningCurveData()`     | `plotLearningCurve()`      | `plotLearningCurveGGVIS()`    | `vignette("learning_curve")`                                          |
