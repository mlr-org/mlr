...
The `mlr` function `generateLearningCurveData()` can generate the data for *learning curves* for multiple learners (`vignette("integrated_learners")`) and multiple performance measures (`vignette("measures")`) at once.
