...
The `mlr` function `generateLearningCurveData()` can generate the data for *learning curves* for [multiple learners](integrated_learners.html) and multiple [performance measures](measures.html) at once.
