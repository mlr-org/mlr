...
If you find that a measure is missing, you can either [open an issue](https://github.com/mlr-org/mlr/issues) or try to implement a measure yourself (`vignette("custom_measures")`).
...
For details see the tutorial page on cost-sensitive classification (`vignette("cost_sensitive_classif")`) and also the page on custom performance measures (`vignette("custom_measures")`).
