...
```{r echo=FALSE, out.width = "400pt", fig.align='center', fig.cap="Nested Spatial and Non-Spatial Validation"}
knitr::include_graphics(here::here("vignettes/tutorial/2.12/pdf/img/spatial_cross_validation.png"))
```
