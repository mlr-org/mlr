...
In the above example, generating a [Learner](&makeLearner) is not strictly necessary.
Generally, you have to create a [Learner](&makeLearner) if you want to change any defaults
