...
cost-sensitive learning, and [ClusterTask][&Task] for clustering.

There are dedicated functions to create these tasks given data and other
relevant information. These are [makeClassifTask][&Task],
[makeRegrTask][&Task],
...
The most important ones are listed in [&Task].
...
which stands for "description" and is of class [&TaskDesc].

```{r}
str(classif.task$task.desc)
```

The [&Task] help page also lists several other arguments
