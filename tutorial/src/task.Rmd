...
Depending on the nature if the learning problem, additional arguments may be required and are exemplified in the following subsections.
...
We use the iris data and generate an artificial cost matrix (following [Beygelzimer et al. (2005)](http://dx.doi.org/10.1145/1102351.1102358)):
