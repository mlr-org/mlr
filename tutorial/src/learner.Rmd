...
To see which learners are already implemented, have a look at the [&learners] documentation page.

A learner in **mlr** is constructed by calling [&makeLearner].
...
The generated learner is an object of class [Learner](&makeLearner).
