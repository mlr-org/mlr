...
For example *rcens* means that the Learner can deal with right censored data.
Moreover, the type of prediction is displayed.
For *classification* and *survival analysis* *prob* indicates that probabilities can be predicted.
