...
The aim is normally to compare and rank the algorithms with respect to one or more
performance measures.

In **mlr** a benchmark experiment can be conducted by calling function [&benchmark] on a
...
res = benchmark(lrn, iris.task, rdesc, measure = acc, show.info = FALSE)
res
...
res = benchmark(tasks = iris.task, learners = lrns, resampling = rdesc, show.info = FALSE)
res
