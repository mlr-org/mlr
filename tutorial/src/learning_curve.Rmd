...
You can define the resampling method in the `resampling` argument of [&generateLearningCurve].
...
The [%mlr] function [&generateLearningCurve] can generate the data for *learning curves*
...
lc = generateLearningCurve(learners = lrns, task = sonar.task, percs = seq(0.1, 1, by = 0.1), measures = acc,
