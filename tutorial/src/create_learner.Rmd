...
Add information for the properties (see also the section on [learners](learner.md)).
...
Simply access the real fitted model through ``.model$learner.model``.
...
is ``"response"``, or a matrix of predicted probabilities if
