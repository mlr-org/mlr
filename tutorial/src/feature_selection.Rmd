...
[&getFilterValues]. Currently, classification, regression and survival analysis tasks
are supported. A table showing all available methods can be found [here](filter_methods.md).

Function [&getFilterValues] requires the [&Task] and a character string specifying the filter
method.
...
that gives the importance values for all features.
