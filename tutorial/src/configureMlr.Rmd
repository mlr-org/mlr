...
Actually **mlr** is just designed to make errors due to typos or invalid parameter values
...
Another not uncommon situation is that a particular learning method throws an error.
