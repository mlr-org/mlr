...
A [&Prediction] object is a [list](&base::list). The most important element is ``data`` which is a
...
To illustrate binary classification, we use the [Sonar](&mlbench::Sonar)
data set from the
