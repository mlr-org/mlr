...
probabilities.
For binary classification you set the threshold for the *positive* class.
The default is 0.5.
...
It works similar for multiclass classification.
...
For *classification*, we get a scatter plot of 2 features (per default the first 2 in the data set).
...
See the sections [Performance](&performance.md) and
