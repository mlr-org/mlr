...
rin = makeResampleInstance(rdesc, sonar.task)

## Calculate the error rate (for threshold 0.5) and the AUC
ms = list(mmce, auc)
r1 = resample(lrn1, sonar.task, rin, measures = ms, show.info = FALSE)
r2 = resample(lrn2, sonar.task, rin, measures = ms, show.info = FALSE)
```
