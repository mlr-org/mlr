...
accuracy ([&acc]) or measures based on ROC analysis for classification and mean
...
To see which performance measures are implemented, have a look at [&measures].
...
In order to calculate the performance measures, the function [&performance] is used.
...
probabilities are predicted, i.e. set the predict type of the [Learner](&makeLearner) to "prob".
